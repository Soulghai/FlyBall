...
#define kConsumableBaseFeatureId @"ExpandIt_Test_IAP"
#define kFeatureAId @"Expandit_5_SuperRainbows"
#define kFeatureBId @"Expandit_15_SuperRainbows"
#define kConsumableFeatureBId @"com.expandit.myapp.005"
